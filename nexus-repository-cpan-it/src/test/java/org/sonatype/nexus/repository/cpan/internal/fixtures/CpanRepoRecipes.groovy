...
/**
 * Factory for cpan {@link Repository} {@link Configuration}
 */
@CompileStatic
trait CpanRepoRecipes
    extends ConfigurationRecipes
{
  @Nonnull
  Repository createCpanProxy(final String name,
                             final String remoteUrl)
  {
    createRepository(createProxy(name, 'cpan-proxy', remoteUrl))
  }
